...
import SideComponent from "../pages/member/SideComponent";
import FooterComponent from "../pages/member/FooterComponent";
    ...
    return (
        <>
            ...
            <div className={`grid grid-cols-1 ${isMobile ? 'md:grid-cols-1' : 'md:grid-cols-6'} gap-4`}>
                {/* 사이드바 영역 */}
                <div className={`col-span-2 p-5 ${isMobile ? "hidden" : "block"}`}>
                    <SideComponent/>
                </div>
                {/* 메인 영역 */}
